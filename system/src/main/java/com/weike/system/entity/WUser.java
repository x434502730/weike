...
public class WUser implements Serializable{
    ...
    private static final long serialVersionUID = -8065804411892257592L;
    ...
    public WUser(String id, String loginName, String password, String vsername, String mobile, String email, Date genTime, Date loginTime, Date lastLoginTime, Long count) {
        this.id = id;
